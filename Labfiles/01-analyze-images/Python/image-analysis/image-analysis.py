...
def main():
    ...
    try:
        ...
        # Get image
        image_file = r'C:\Users\vamsh\OneDrive\Documents\GitHub\mslearn-ai-vision\Labfiles\01-analyze-images\Python\image-analysis\images\street.jpg'
        if len(sys.argv) > 1:
